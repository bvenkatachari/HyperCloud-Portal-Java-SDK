...
public class VirtualMachineServiceImpl
  extends GenericServiceImpl<PriceProfile, ResponseEntity<List<PriceProfile>>, ResponseEntity<PriceProfile>>
  ...
  */
 public VirtualMachineServiceImpl(String baseURI, String username, String password) {
