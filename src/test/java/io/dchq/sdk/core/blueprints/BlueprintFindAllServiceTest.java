...
public class BlueprintFindAllServiceTest extends AbstractServiceTest {
	...
	public static Collection<Object[]> data() {
		return Arrays.asList(new Object[][]{
				...
				{"Docker Blueprint", BlueprintType.DOCKER_COMPOSE, "7.0", "LB:\n image: nginx:latest\n", Visibility.READABLE, "", EntitlementType.NONE, false},
				{"Docker Blueprint", BlueprintType.DOCKER_COMPOSE, "2.0", "LB:\n image: nginx:latest\n", Visibility.EDITABLE, "", EntitlementType.CUSTOM, false},
				{"Docker Blueprint", BlueprintType.DOCKER_COMPOSE, "2.0", "LB:\n image: nginx:latest\n", Visibility.READABLE, "", EntitlementType.CUSTOM, false},
				{"Docker Blueprint", BlueprintType.DOCKER_COMPOSE, "2.0", "LB:\n image: nginx:latest\n", Visibility.HIDE, "", EntitlementType.CUSTOM, false},
				{"123", BlueprintType.DOCKER_COMPOSE, "2.0", "LB:\n image: nginx:latest\n", Visibility.EDITABLE, "", EntitlementType.CUSTOM, false},
				{"123", BlueprintType.DOCKER_COMPOSE, "2.0", "LB:\n image: nginx:latest\n", Visibility.READABLE, "", EntitlementType.CUSTOM, false},
				{"123", BlueprintType.DOCKER_COMPOSE, "2.0", "LB:\n image: nginx:latest\n", Visibility.HIDE, "", EntitlementType.CUSTOM, false},

				{"Docker Blueprint", BlueprintType.DOCKER_COMPOSE, "2.0", "LB:\n image: nginx:latest\n", Visibility.EDITABLE, "", EntitlementType.OWNER, false},
				{"Docker Blueprint", BlueprintType.DOCKER_COMPOSE, "2.0", "LB:\n image: nginx:latest\n", Visibility.READABLE, "", EntitlementType.OWNER, false},
				{"Docker Blueprint", BlueprintType.DOCKER_COMPOSE, "2.0", "LB:\n image: nginx:latest\n", Visibility.HIDE, "", EntitlementType.OWNER, false},
				{"123", BlueprintType.DOCKER_COMPOSE, "2.0", "LB:\n image: nginx:latest\n", Visibility.EDITABLE, "", EntitlementType.OWNER, false},
				{"123", BlueprintType.DOCKER_COMPOSE, "2.0", "LB:\n image: nginx:latest\n", Visibility.READABLE, "", EntitlementType.OWNER, false},
				{"123", BlueprintType.DOCKER_COMPOSE, "2.0", "LB:\n image: nginx:latest\n", Visibility.HIDE, "", EntitlementType.OWNER, false},
				...
				{"Docker Blueprint", BlueprintType.DOCKER_COMPOSE, "2.0", "LB:\n image: nginx:latest\n", Visibility.EDITABLE, "", EntitlementType.NONE, false},
				{"Docker Blueprint", BlueprintType.DOCKER_COMPOSE, "2.0", "LB:\n image: nginx:latest\n", Visibility.READABLE, "", EntitlementType.NONE, false},
				{"Docker Blueprint", BlueprintType.DOCKER_COMPOSE, "2.0", "LB:\n image: nginx:latest\n", Visibility.HIDE, "", EntitlementType.NONE, false},
				{"123", BlueprintType.DOCKER_COMPOSE, "2.0", "LB:\n image: nginx:latest\n", Visibility.EDITABLE, "", EntitlementType.NONE, false},
				{"123", BlueprintType.DOCKER_COMPOSE, "2.0", "LB:\n image: nginx:latest\n", Visibility.READABLE, "", EntitlementType.NONE, false},
				{"123", BlueprintType.DOCKER_COMPOSE, "2.0", "LB:\n image: nginx:latest\n", Visibility.HIDE, "", EntitlementType.NONE, false},

				{"Docker Blueprint", BlueprintType.DOCKER_COMPOSE, "2.0", "LB:\n image: nginx:latest\n", Visibility.EDITABLE, "", EntitlementType.PUBLIC, false},
				{"Docker Blueprint", BlueprintType.DOCKER_COMPOSE, "2.0", "LB:\n image: nginx:latest\n", Visibility.READABLE, "", EntitlementType.PUBLIC, false},
