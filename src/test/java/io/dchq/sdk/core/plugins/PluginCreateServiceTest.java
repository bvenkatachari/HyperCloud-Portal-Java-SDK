...
this.errors = errors;
    ...
    public static Collection<Object[]> data() {
        return Arrays.asList(new Object[][]{
				...
				{ "TestPlugin11", "1.3", "Description", "Dummy Script", "PERL", "Apache License 2.0", 30,
						EntitlementType.CUSTOM, true, userId2, null,
						new HashSet<>(Arrays.asList(new Env().withProp("prop1").withVal("val1"))), true, false },
				
				{ "Test", null, null, "script", "SHELL", "", 30, EntitlementType.CUSTOM, true, userId2, null, null,
						true, false },
				
				{ "TestPlugin", "1.3", null, "Dummy Script", "PYTHON", "Apache License 2.0", 30, EntitlementType.CUSTOM,
						true, userId2, null, new HashSet<>(Arrays.asList(new Env().withProp("prop1").withVal("val1"))),
						true, false },
				
				{ "TestPlugin001", "1.0", "Description", "Dummy Script", "SHELL", "Apache License 2.0", 30,
						EntitlementType.CUSTOM, true, userId2, null,
						new HashSet<>(Arrays.asList(new Env().withProp("prop1").withVal("val1"))), true, false },
				
				{ "TestPlugin002", "1.3", "Description", "Dummy Script", "PERL", "Apache License 2.0", 30,
						EntitlementType.CUSTOM, true, userId2, null,
						new HashSet<>(Arrays.asList(new Env().withProp("prop1").withVal("val1"))), true, false },

				{ "TestPlugin11", "1.3", "Description", "Dummy Script", "POWERSHELL", "Apache License 2.0", 30,
						EntitlementType.CUSTOM, true, userId2, null,
						new HashSet<>(Arrays.asList(new Env().withProp("prop1").withVal("val1"))), true, false },
				{ "TestPlugin11", "1.3", "Description", "Dummy Script", "RUBY", "Apache License 2.0", 30,
						EntitlementType.CUSTOM, true, userId2, null,
						new HashSet<>(Arrays.asList(new Env().withProp("prop1").withVal("val1"))), true, false },
				{ "TestPlugin11", "1.3", "Description", "Dummy Script", "PYTHON", "Apache License 2.0", 30,
						EntitlementType.CUSTOM, true, userId2, null,
						new HashSet<>(Arrays.asList(new Env().withProp("prop1").withVal("val1"))), true, false },
				{ "TestPlugin11", "1.3", "", "Dummy Script", "PYTHON", "Apache License 2.0", 30, EntitlementType.CUSTOM,
						true, userId2, null, new HashSet<>(Arrays.asList(new Env().withProp("prop1").withVal("val1"))),
						true, false },

				{ "TestPlugin11", "1.3", null, "Dummy Script", "PYTHON", "Apache License 2.0", 30,
						EntitlementType.CUSTOM, true, userId2, null,
						new HashSet<>(Arrays.asList(new Env().withProp("prop1").withVal("val1"))), true, false },
				{ "TestPlugin11", null, null, "script", "SHELL", "", 30, EntitlementType.CUSTOM, true, userId2, null,
						new HashSet<>(Arrays.asList(new Env().withProp("prop1").withVal("val1"))), true, false },
				{ "TestPlugin11", "1.2", "Description", "Dummy Script", "SHELL", "Apache License 2.0", 30,
						EntitlementType.CUSTOM, true, userId2, null,
						new HashSet<>(Arrays.asList(new Env().withProp("prop1").withVal("val1"))), true, false },
				{ "TESTPLUGIN011", "1.2", "", "Dummy Script", "SHELL", "", 30, EntitlementType.CUSTOM, true, userId2,
						null, new HashSet<>(Arrays.asList(new Env().withProp("prop1").withVal("val1"))), true, false },
				{ "TestPlugin[1]", "1.2", "", "Dummy Script", "SHELL", "", 30, EntitlementType.CUSTOM, true, userId2,
						null, new HashSet<>(Arrays.asList(new Env().withProp("prop1").withVal("val1"))), true, false },
				{ "TestPlugin@1$", "1.2", "", "Dummy Script", "SHELL", "", 30, EntitlementType.CUSTOM, true, userId2,
						null, new HashSet<>(Arrays.asList(new Env().withProp("prop1").withVal("val1"))), true, false },

				{ "TestPlugin11", "", "", "Dummy Script", "PYTHON", "Apache License 2.0", 30, EntitlementType.CUSTOM,
						true, userId2, null, new HashSet<>(Arrays.asList(new Env().withProp("prop1").withVal("val1"))),
						true, false },
				{ "TestPlugin11", null, "", "Dummy Script", "PYTHON", "Apache License 2.0", 30, EntitlementType.CUSTOM,
						true, userId2, null, new HashSet<>(Arrays.asList(new Env().withProp("prop1").withVal("val1"))),
						true, false },
				{ "TestPlugin11", null, "", "Dummy Script", "", "Apache License 2.0", 30, EntitlementType.CUSTOM, true,
						userId2, null, new HashSet<>(Arrays.asList(new Env().withProp("prop1").withVal("val1"))), true,
						false },
				{ "TestPlugin11", null, "", "Dummy Script", null, "Apache License 2.0", 30, EntitlementType.CUSTOM,
						true, userId2, null, new HashSet<>(Arrays.asList(new Env().withProp("prop1").withVal("val1"))),
						true, false },
				{ "TestPlugin11", null, "", "Dummy Script", null, "", 30, EntitlementType.CUSTOM, true, userId2, null,
						new HashSet<>(Arrays.asList(new Env().withProp("prop1").withVal("val1"))), true, false },
				{ "TestPlugin11", null, "", "Dummy Script", null, null, 30, EntitlementType.CUSTOM, true, userId2, null,
						new HashSet<>(Arrays.asList(new Env().withProp("prop1").withVal("val1"))), true, false },
				{ "TestPlugin11", null, "", "Dummy Script", null, null, 30, EntitlementType.CUSTOM, true, userId2, null,
						null, true, false },
				{ "TestPlugin11", null, "", "Dummy Script", null, null, 30, EntitlementType.OWNER, true, userId2, null,
						null, true, false },

				// Name with Uppercase letters[A-Z],special
				// characters[!,@,#,$,....] ,
				{ "TESTPLUGIN", "1.0", "Description", "Dummy Script", "SHELL", "", 30, EntitlementType.CUSTOM, true,
						userId2, null, new HashSet<>(Arrays.asList(new Env().withProp("prop1").withVal("val1"))), true,
						false },
				{ "TestPlugin[1]", "1.0", "Description", "Dummy Script", "SHELL", "", 30, EntitlementType.CUSTOM, true,
						userId2, null, new HashSet<>(Arrays.asList(new Env().withProp("prop1").withVal("val1"))), true,
						false },
				{ "TestPlugin@1$", null, "Description", "Dummy Script", "SHELL", "", 30, EntitlementType.CUSTOM, true,
						userId2, null, new HashSet<>(Arrays.asList(new Env().withProp("prop1").withVal("val1"))), true,
						false },

				// version with Uppercase letters[A-Z],special
				// characters[!,@,#,$,....] ,
				{ "TestPlugin11", "1.3Ab$", "Description", "Dummy Script", "SHELL", "EULA", 30, EntitlementType.CUSTOM,
						true, userId2, null, new HashSet<>(Arrays.asList(new Env().withProp("prop1").withVal("val1"))),
						true, false },
				{ "TestPlugin11", "@1.3A$", "Description", "Dummy Script", "SHELL", "EULA", 30, EntitlementType.CUSTOM,
						true, userId2, null, new HashSet<>(Arrays.asList(new Env().withProp("prop1").withVal("val1"))),
						true, false },

				// License
				{ "TestPlugin11", "1.3", "Description", "Dummy Script", "SHELL", "EULA", 30, EntitlementType.CUSTOM,
						true, userId2, null, new HashSet<>(Arrays.asList(new Env().withProp("prop1").withVal("val1"))),
						true, false },
				{ "TestPlugin11", "1.3", "Description", "Dummy Script", "SHELL", "Apache License 2.0", 30,
						EntitlementType.CUSTOM, true, userId2, null,
						new HashSet<>(Arrays.asList(new Env().withProp("prop1").withVal("val1"))), true, false },
				{ "TestPlugin11", "1.3", "Description", "Dummy Script", "SHELL", null, 30, EntitlementType.CUSTOM, true,
						userId2, null, new HashSet<>(Arrays.asList(new Env().withProp("prop1").withVal("val1"))), true,
						false },

				// Negative Test-Cases

				{ "", "1.2", "Description", "Dummy Script", "SHELL", "Apache License 2.0", 30, EntitlementType.CUSTOM,
						true, userId2, null, new HashSet<>(Arrays.asList(new Env().withProp("prop1").withVal("val1"))),
						true, true },
				//{ null, "1.2", "Description", "Dummy Script", "SHELL", "Apache License 2.0", 30, EntitlementType.CUSTOM,
				//		true, userId2, null, new HashSet<>(Arrays.asList(new Env().withProp("prop1").withVal("val1"))),
				//		true, true },

				// script
				{ "TestPlugin11", "1.2", "Description", "", "SHELL", "Apache License 2.0", 30, EntitlementType.CUSTOM,
						true, userId2, null, new HashSet<>(Arrays.asList(new Env().withProp("prop1").withVal("val1"))),
						true, true },
				{ "TestPlugin11", "1.2", "Description", null, "SHELL", "Apache License 2.0", 30, EntitlementType.CUSTOM,
						true, userId2, null, new HashSet<>(Arrays.asList(new Env().withProp("prop1").withVal("val1"))),
						true, true },
