...
public class VirtualNetworkFindServiceTest extends AbstractServiceTest {
	...
	public VirtualNetworkFindServiceTest(String name, String driver, EntitlementType entitlementType, String vlanId, boolean isprifix, boolean success)
	{
	...
	public void findTest()
	{
		...
		if (this.sussess) {
			...
			{
				this.findVlan= resultFindResponse.getResults();
				logger.info("Find vlan Successfully..");
			}
			Assert.assertEquals(findVlan.getName(), virtualNetwork.getName());
			Assert.assertEquals(findVlan.getDriver(), virtualNetwork.getDriver());
			Assert.assertEquals(findVlan.getVlanId(), virtualNetwork.getVlanId());
