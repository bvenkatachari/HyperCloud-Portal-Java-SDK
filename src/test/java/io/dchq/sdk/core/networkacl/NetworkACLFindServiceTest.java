...
public class NetworkACLFindServiceTest extends NetworkACLUtil {
	...
	public NetworkACLFindServiceTest(String networkACLName, String subnet_Id, EntitlementType entitlementType, boolean isprifix, boolean success) {
