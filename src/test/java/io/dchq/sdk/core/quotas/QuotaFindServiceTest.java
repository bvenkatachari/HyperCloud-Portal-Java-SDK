...
public class QuotaFindServiceTest extends AbstractServiceTest {
	...
	public QuotaFindServiceTest(String name, String rpType, int cpu, int memory, int disk) {
	...
	public void testFind() throws Exception {
		...
		response = resourcePoolService.findById(quotaCreated.getId());
		for (Message message : response.getMessages()) {
		...
		assertEquals(quotaCreated.getRpType(), findEntity.getRpType());
		assertEquals(quotaCreated.getName(), findEntity.getName());
		assertEquals(quotaCreated.getCpu(), findEntity.getCpu());
		assertEquals(quotaCreated.getMem(), findEntity.getMem());
		assertEquals(quotaCreated.getDisk(), findEntity.getDisk());
