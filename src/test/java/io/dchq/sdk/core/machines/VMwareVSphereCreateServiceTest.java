...
public class VMwareVSphereCreateServiceTest extends DockerServerTest {
    ...
    public VMwareVSphereCreateServiceTest(String serverName, Boolean activeFlag, String hardwareID, String image, String networkId, int size, String endpoint, int tinout, String clusterName, boolean success, boolean installAgent, boolean isConnected) {
