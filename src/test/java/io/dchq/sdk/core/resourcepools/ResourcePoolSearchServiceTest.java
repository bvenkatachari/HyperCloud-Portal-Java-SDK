...
public class ResourcePoolSearchServiceTest extends AbstractServiceTest {

	private ResourcePoolService resourcePoolService;
	private ResourcePool resourcePool;
	private ResourcePool resourcePoolCreated;

	public ResourcePoolSearchServiceTest(String name, String rpType, int cpu, int memory, int disk, EntitlementType entitleType) {
	...
	public void testCreate() throws Exception {
		...
		ResponseEntity<List<ResourcePool>> quotaResponseEntity = resourcePoolService.search(resourcePoolCreated.getName(), 0, 1);
