...
public class ResourcePoolCreateServiceTest extends AbstractServiceTest {

	private ResourcePoolService resourcePoolService;
	private ResourcePool resourcePool;
	private ResourcePool resourcePoolCreated;

	public ResourcePoolCreateServiceTest(String name, String rpType, int cpu, int memory, int disk, EntitlementType entitleType) {
